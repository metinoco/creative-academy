...
// TODO (1.8 — Emails): invocar Edge Function con Resend cuando esté configurada
async function notifyAccessRevoked(_userEmail: string, _courseTitle: string) {
  // await supabase.functions.invoke("send-email", {
  //   body: { type: "access_revoked", to: _userEmail, courseTitle: _courseTitle },
  // });
}
        ...
        <div className={`p-4 border-t ${ADMIN_BORDER} shrink-0 space-y-2`}>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              onClick={() => grantMutation.mutate({ courseId: selectedCourseId })}
